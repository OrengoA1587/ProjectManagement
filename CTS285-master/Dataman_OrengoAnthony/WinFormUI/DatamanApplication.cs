...
namespace WinFormUI
{
    ...
    {
        #region Variables, Objects,Classes
        int numberOne = 0;
        int numberTwo = 0;
        int userAnswer = 0;
        int correctAnswer = 0;
        ...
        private void forceOutButton_Click(object sender, EventArgs e)
        {
            ...
            if (forceOutNumber == 0)
            {
                GetRandomNumber(ref forceOutNumber, randInt);
            }            
            responseBox.Text = forceOutNumber.ToString();
            outputBox.Text = "Player1 make a selection between 1 and 9";
             
        }
        private void GetRandomNumber(ref int forceOutNumber, Random randInt)
        {
