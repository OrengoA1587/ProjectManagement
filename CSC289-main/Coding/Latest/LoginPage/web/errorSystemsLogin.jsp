<%-- 
    Document   : errorSystemsLogin
    Created on : Mar 18, 2021, 6:52:57 PM
    Author     : Anthony
--%>
...
<html>
    <head>
        <meta http-equiv="refresh" content="5;url=indexSystemLoginOption.jsp" />
    ...
    <body>  
        <nav>
            ...
            <div>                    
                <a href="indexSystemLoginOption.jsp">Home</a>         
            </div>           
        </nav> 
        <header class="error"> 
