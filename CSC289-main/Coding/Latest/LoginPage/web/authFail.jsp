...
<html>
    <head>
        <meta http-equiv="refresh" content="5;url=activateAccount.jsp" />
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Unsuccessful Authorization</title>
            ...
            <div class="login-clean-user-login">            
                <form action="indexUserLogin.jsp" method="post" >
                    <div class="illustration">   
                        <br><br>
                        <img src="assetsJSP/css/images/DBErrorIcon.png" width="80" height="80">
                    </div>
                    <div class="form-group">   
                        <br>
                        <p><center><h2>Authorization Failed</h2></center></p>                        
                    </div>  
                    <div class="form-group">
